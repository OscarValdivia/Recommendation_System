...
db = connect() #makes the connectio with the database (see db_connect.rb)
...
users, ads = parser(source_users, source_ads) #returns an array with all the users and ads objects (see parse.rb)
