...
class Rs
    ...
    def initialize(nmatrix, metric = method(:metric_manhattan))
    ...
    def top_kn(u1, kn = 5, nmatrix = @nmatrix)
    ...
    def sim_item(item, nmatrix = @nmatrix)
    ...
    def get_rs_data(id, num = @dist_all[id].length)
